...
class Main : XposedModule() {
        ...
        when (packageName) {
            ...
            Package.GALLERY -> {
                ...
                if (preference.other.supportGalleryGoogleSync) {
                    Gallery.supportGoogleSync()
                }
                Gallery.applyFeatureOverrides(preference.other)
            }
            ...
            Package.STORE -> {
                ...
                if (preference.other.changeRegion) {
                    GalaxyStore.changeRegion(preference.other.regionCode)
                }
            }
    ...
    override fun onSystemServerStarting(param: XposedModuleInterface.SystemServerStartingParam) = with(param) {
        ...
        if (preference.android.disableAsksRestriction) {
            Android.disableAsksRestriction()
        }
